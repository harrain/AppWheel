package com.damon.appwheel.ui.home.adapter;
...
import com.damon.appwheel.ui.home.hotlist.HotListHAdapter;
...
public class HotListAdapter extends DelegateAdapter.Adapter<HotListAdapter.MainViewHolder> {
  ...
  public void setHotListData(List<HotThing> list) {
    mHotLists.clear();
    mHotLists.addAll(list);
//    mHotListHAdapter.addData(datas);
