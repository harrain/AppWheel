...
import com.damon.appwheel.model.util.GalaryHelper;
import com.damon.appwheel.ui.adapter.ProfileAdapter;
...
public class ProfileActivity extends BaseTitleActivity {
    ...
    public void initView() {
        ...
        super.initView();
        profileRv = (RecyclerView) findViewById(R.id.profile_rv);
        setmTTitle("个人信息");
...
//        datas.add(new ProfileItemBean("头像",null,"/Android/data/com.damon.appwheel/cache/output_image_36777274.jpg",-1,0));
